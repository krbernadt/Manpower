...
ALTER TABLE IF EXISTS internal.tbm_rev
    ADD FOREIGN KEY (rev_id)
    REFERENCES internal.tbm_rev_sch (rev_id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    NOT VALID;
...
ALTER TABLE IF EXISTS internal.tbm_rev
    ADD FOREIGN KEY (rev_id)
    REFERENCES internal.tb_draft_m_planning (rev_id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    NOT VALID;
...
ALTER TABLE IF EXISTS internal.tbm_rev
    ADD FOREIGN KEY (rev_id)
    REFERENCES internal.tb_m_planning (rev_id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    NOT VALID;
