                                            ...
                                            <table id="table1 " class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
                                                ...
                                                <tbody id="tableBody">
                                                    <?php foreach ($mmp_plan as $plan_dat) : ?>
                                                        <tr class="text-center data-row" id="row_<?php echo $plan_dat->rev_id; ?>" style="word-wrap: break-word;">
                                    ...
                                    <script>
                                        ...
                                        function saveChanges() {
                                            ...
                                            var emp_mpp = {
                                                ...
                                                sfid: document.getElementById('gid_mod').value,
                                                position_no: document.getElementById('nik_mod').value,
                                                full_name: document.getElementById('gid_mod').value,
                                                job_family: document.getElementById('nik_mod').value,
                                                job_title: document.getElementById('gid_mod').value,
                                                dept: document.getElementById('nik_mod').value,
                                                job_position: document.getElementById('gid_mod').value,
                                                hay_grade: document.getElementById('nik_mod').value,
                                                company: document.getElementById('gid_mod').value,
                                                cc_code: document.getElementById('nik_mod').value,
                                                cc_payroll_code: document.getElementById('gid_mod').value,
                                                grouping: document.getElementById('nik_mod').value,
                                                start: document.getElementById('gid_mod').value,
                                                end: document.getElementById('nik_mod').value,
                                                remark: document.getElementById('gid_mod').value,
                                                notes: document.getElementById('nik_mod').value,
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body" id="body-edit">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="job_pos_mod" id="job_pos_mod" class="form-input input-5" placeholder="Following Corporate Job Position">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="label-2" for="job_pos_mod">Entity :</label>
                                        <input type="text" name="ent" id="ent" class="form-input input-5">
                                    </div>
                                    <div class="form-group">
                                        <label class="label-2" for="grouping_mod">Remark :</label>
                                        <input type="text" name="grouping_mod" id="grouping_mod" class="form-input input-5">
                                    </div>
                                    <div class="form-group">
                                        <label class="label-2" for="grouping_mod">Notes :</label>
                                        <input type="text" name="grouping_mod" id="grouping_mod" class="form-input input-5">
                                    </div>
                                </div>
